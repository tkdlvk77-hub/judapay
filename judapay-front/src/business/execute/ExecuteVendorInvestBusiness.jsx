          ...
          {investType === 'equity' && (
            <>
              <div style={{ marginBottom:'14px' }}>
                ...
                <div style={{ background: COLORS.bgCard, border:`1px solid ${COLORS.border}`, borderRadius: RADIUS.lg, padding:'12px 16px', display:'flex', alignItems:'center', gap:'8px' }}>
                  <input type="number" inputMode="decimal" value={equity} onChange={e => setEquity(e.target.value)}
                    placeholder="예: 10" step="0.1" max="100"
                    style={{ flex:1, fontSize:'18px', fontWeight:700, color: COLORS.t1, border:'none', outline:'none', background:'transparent', fontFamily:'inherit', WebkitAppearance:'none', MozAppearance:'textfield' }} />
                  <span style={{ fontSize:'14px', color: COLORS.t3, fontWeight:600 }}>%</span>
                </div>
              </div>
              {valuation > 0 && (
                <div style={{ marginBottom:'14px' }}>
            ...
            <div style={{ marginBottom:'14px' }}>
              ...
              <div style={{ background: COLORS.bgCard, border:`1px solid ${COLORS.border}`, borderRadius: RADIUS.lg, padding:'12px 16px', display:'flex', alignItems:'center', gap:'8px' }}>
                <input type="number" inputMode="decimal" value={interestRate} onChange={e => setInterestRate(e.target.value)}
                  ...
                  style={{ flex:1, fontSize:'18px', fontWeight:700, color: COLORS.t1, border:'none', outline:'none', background:'transparent', fontFamily:'inherit', WebkitAppearance:'none', MozAppearance:'textfield' }} />
                <span style={{ fontSize:'14px', color: COLORS.t3, fontWeight:600 }}>% /년</span>
              </div>
            </div>
          )}
