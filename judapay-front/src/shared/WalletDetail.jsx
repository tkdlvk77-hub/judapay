...
const WALLET_DATA = {
  my: {
    ...
    txns: [
      { id: 't1', period: '이번달', tag: '입금', tagColor: '#6D28D9', tagBg: '#EDE9FE', name: '(주)오로라 디자인 외주', sub: '사업자 발신 · 10분 전',       amount:  500000, sign:  1, type: '입금' },
      { id: 't2', period: '이번달', tag: '사용', tagColor: '#DC2626', tagBg: '#FEE2E2', name: '박민준 · 빌려주기',      sub: '차용증 + 오두막한 · 1시간 전', amount: 2500000, sign: -1, type: '사용' },
      { id: 't3', period: '이번달', tag: '출금', tagColor: '#D97706', tagBg: '#FEF3C7', name: '국민은행 1234***5678',   sub: '본인 명의 계좌 · 어제 18:42',  amount:  450000, sign: -1, type: '출금' },
      { id: 't4', period: '이번달', tag: '입금', tagColor: '#059669', tagBg: '#D1FAE5', name: '(주)오로라 11월 급여',   sub: '사업자 발신 · 어제 09:00',     amount: 1200000, sign:  1, type: '입금' },
      { id: 't5', period: '이번달', tag: '대기', tagColor: '#D97706', tagBg: '#FFFBEB', name: '배민 외주 정산 대기',    sub: '자동지출 예정 · 5.15',         amount:  320000, sign: -1, type: '대기', holdType: 'AUTO_PAY', scheduledAt: '5.15' },
      { id: 't6', period: '3개월',  tag: '입금', tagColor: '#059669', tagBg: '#D1FAE5', name: '(주)오로라 10월 급여',   sub: '사업자 발신 · 4.30',           amount: 1200000, sign:  1, type: '입금' },
      { id: 't7', period: '3개월',  tag: '사용', tagColor: '#DC2626', tagBg: '#FEE2E2', name: '카카오 구독',            sub: '자동결제 · 4.01',              amount:   19000, sign: -1, type: '사용' },
    ],
  },
  edu: {
  ...
  return (
    <PhoneShell>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        {/* ── Header ── */}
        <div style={{ background: theme.headerGrad, paddingBottom: '20px', flexShrink: 0 }}>

          {/* Nav */}
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: 'max(20px, env(safe-area-inset-top))', paddingRight: '16px', paddingBottom: '0', paddingLeft: '16px' }}>
