...
export default function Withdraw() {
  ...
  if (step === 'confirm') return (
    <PhoneShell>
      <div style={{ display:'flex', flexDirection:'column', height:'100%' }}>
        <BrandHeader title="출금 확인" onBack={goBack} bg={theme.headerGrad} />
  ...
  if (step === 'pin') return (
    <PhoneShell>
      <div style={{ display:'flex', flexDirection:'column', height:'100%' }}>
        <BrandHeader title="비밀번호 입력" onBack={goBack} bg={theme.headerGrad} />
  ...
  return (
    <PhoneShell>
      <div style={{ display:'flex', flexDirection:'column', height:'100%' }}>
        <BrandHeader title="출금 완료" onBack={() => navigate(-1)} bg={theme.headerGrad} />
